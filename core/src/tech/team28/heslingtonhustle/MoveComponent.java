...
/**
 * The {@code MoveComponent} class handles the movement of a collider(Rectangle) within the game world.
 * It utilizes a target velocity to smoothly interpolate the current velocity towards it, simulating acceleration.
 */
public class MoveComponent {
    ...
    /**
     * Moves a collider(Rectangle) towards a given direction by interpolating its velocity and updating its position.
     *
    ...
    public void MoveTowards(Vector2 direction, Rectangle collider, float delta){
        ...
        // Interpolate the current velocity towards the target velocity with smooth interpolation mode
